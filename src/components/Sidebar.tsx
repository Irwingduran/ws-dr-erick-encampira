...
export default function Sidebar() {
  ...
  return (
    <>
      {/* Mobile Menu Button */}
      <button
        className="fixed top-4 right-4 z-50 text-white bg-gray-800 p-2 rounded-md md:hidden"
      ...
      >
        ...
        <div className="flex flex-col items-center pt-8 pb-12">
          <a href="/">
            <img src="/log.avif" alt="logo" width={250} />
            <p className="text-gray-300 mt-2">Dr. Erick O. Encampira Luna</p>
          </a>
        </div>
        ...
        <div className="p-8 space-y-4">
          ...
          <div className="text-sm text-gray-400 space-y-2">
            <p>
              Creado por{" "}
              <a
                href="https://delta-digital.com.mx/"
